...
# def _unpartitioned_dataframe_to_data_file(
#     table_metadata: TableMetadata,
#     df: pa.Table,
#     io: FileIO,
...
# ):
#     """Convert a list of partitioned PyArrow tables with their partition keys into a list of DataFiles.
...
# def _partitioned_dataframes_to_data_files(
#     table_metadata: TableMetadata,
#     dfs: List[TablePartition], # let _dataframes_to_data_files know about partitions is terrible???
#     io: FileIO,
#     write_uuid: Optional[uuid.UUID] = None,
#     counter: Optional[itertools.count[int]] = None,
# ) -> Iterable[DataFile]:
...
#                 partition_key=partitioned_slice.partition_key, #TablePartition could have no partition key, meaning it is a normal df not partitioned, i dont like such branching, this is 'branching at low level', you call input a list of partiionslices but they are actuallt not, I would rather create 2 functions - 1 as dataframe to datafile, 2 data frame to partitioned datafies and then branching outside
#                 schema=table_metadata.schema(),
#             )
#             for partitioned_slice in dfs
#             for batches in bin_pack_arrow_table(partitioned_slice.arrow_table_partition, target_file_size)
#         ]),
#     )
