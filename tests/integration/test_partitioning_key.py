...
def test_partition_key(
    ...
    if True:  # spark_create_table_sql_for_justification is not None and spark_data_insert_sql_for_justification is not None:
        try:
        ...
        print(type(spark_partition_for_justification[0]), spark_partition_for_justification[0])
